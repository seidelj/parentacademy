...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_calender_calenderplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('events', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calender.Events'])),
        ))
        db.send_create_signal(u'djangocms_calender', ['CalenderPlugin'])


    def backwards(self, orm):
        # Deleting model 'CalenderPlugin'
        db.delete_table(u'djangocms_calender_calenderplugin')
    ...
    models = {
        ...
        u'djangocms_calender.calenderplugin': {
    ...
    complete_apps = ['djangocms_calender']