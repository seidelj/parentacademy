...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_staff_staffplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('staff', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Staff'])),
        ))
        db.send_create_signal(u'djangocms_staff', ['StaffPlugin'])


    def backwards(self, orm):
        # Deleting model 'StaffPlugin'
        db.delete_table(u'djangocms_staff_staffplugin')
    ...
    models = {
        ...
        u'djangocms_staff.staffplugin': {
            'Meta': {'object_name': 'StaffPlugin', '_ormbases': ['cms.CMSPlugin']},
